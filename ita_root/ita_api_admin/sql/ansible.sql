...
-- V000_Movement_変数タイプ紐付けビュー
CREATE VIEW V_ANSR_MVMT_VAR_LINK_ATTR AS
SELECT
...
LEFT JOIN T_ANSR_ROLE_VAR TAB_B ON (TAB_A.VARS_NAME_ID = TAB_B.VARS_NAME_ID);
...
AND TAB_A.AUTOREG_ONLY_ITEM = 1
AND TAB_A.DISUSE_FLAG = 0
AND TAB_B.SHEET_TYPE = 1 OR TAB_B.SHEET_TYPE = 2
...
TAB_A.LAST_UPDATE_USER
FROM 
V_ANSR_MVMT_VAR_LINK_ATTR TAB_A
WHERE 
TAB_A.DISUSE_FLAG = 0;
...
WHERE
TAB_A.AUTOREG_HIDE_ITEM = 0
AND
TAB_A.AUTOREG_ONLY_ITEM = 1
AND
TAB_A.DISUSE_FLAG = 0
AND
TAB_B.SHEET_TYPE = 1 OR TAB_B.SHEET_TYPE = 2
AND
TAB_B.DISUSE_FLAG = 0
AND
TAB_C.DISUSE_FLAG = 0;
...
LEFT JOIN
V_ANSR_MVMT_VAR_LINK_ATTR TAB_B ON (TAB_A.MVMT_VAR_LINK_ID = TAB_B.MVMT_VAR_LINK_ID)
LEFT JOIN
...
T_ANSR_NESTVAR_MEMBER_COL_COMB TAB_A
LEFT JOIN
V_ANSR_MVMT_VAR_LINK TAB_B ON (TAB_A.MVMT_VAR_LINK_ID = TAB_B.MVMT_VAR_LINK_ID)
LEFT JOIN
T_ANSR_ROLE_VAR TAB_C ON (TAB_B.VARS_NAME_ID = TAB_C.VARS_NAME_ID)
WHERE
TAB_A.DISUSE_FLAG = 0
