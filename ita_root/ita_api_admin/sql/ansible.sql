...
LEFT JOIN V_ANSR_MOVEMENT TAB_C ON (TAB_B.MOVEMENT_ID = TAB_C.MOVEMENT_ID)
LEFT JOIN T_ANSR_NESTVAR_MEMBER TAB_D ON (TAB_A.ARRAY_MEMBER_ID = TAB_D.ARRAY_MEMBER_ID)
WHERE
TAB_A.DISUSE_FLAG = 0
AND TAB_B.DISUSE_FLAG = 0
AND TAB_C.DISUSE_FLAG = 0
...
LEFT JOIN T_ANSR_MVMT_VAR_LINK TAB_B ON (TAB_A.MVMT_VAR_LINK_ID = TAB_B.MVMT_VAR_LINK_ID)
LEFT JOIN V_ANSR_MOVEMENT_JNL TAB_C ON (TAB_B.MOVEMENT_ID = TAB_C.MOVEMENT_ID)
LEFT JOIN T_ANSR_NESTVAR_MEMBER TAB_D ON (TAB_A.ARRAY_MEMBER_ID = TAB_D.ARRAY_MEMBER_ID)
WHERE
TAB_A.DISUSE_FLAG = 0
AND TAB_B.DISUSE_FLAG = 0
...
T_ANSR_MVMT_VAR_LINK TAB_B ON (TAB_A.MVMT_VAR_LINK_ID = TAB_B.MVMT_VAR_LINK_ID)
LEFT JOIN
T_ANSR_NESTVAR_MEMBER_COL_COMB TAB_C ON (TAB_A.COL_SEQ_COMBINATION_ID = TAB_C.COL_SEQ_COMBINATION_ID)
WHERE
TAB_A.DISUSE_FLAG = 0
AND
TAB_B.DISUSE_FLAG = 0
